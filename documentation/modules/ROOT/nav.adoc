...
* xref:3-account-microservice.adoc[2. Deploy Account Microservice]
** xref:2-account-microservice.adoc#new-app[Create the Account Microservice Application]
** xref:2-account-microservice.adoc#query-account[List Available Accounts]
** xref:2-account-microservice.adoc#check-logs[Check the Account Microservice logs]
